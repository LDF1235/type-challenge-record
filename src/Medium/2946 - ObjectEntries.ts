...
type _ObjectEntries<T, A = keyof T> = A extends infer B
  ?
      | [B, B extends keyof T ? ([T[B]] extends [never] ? undefined : T[B]) : never]
      | _ObjectEntries<Omit<T, B extends keyof T ? B : never>>
  : never;
