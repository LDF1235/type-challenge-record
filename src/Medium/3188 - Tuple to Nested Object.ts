...
type _TupleToNestedObject<T, U, A> = T extends [...infer F, infer R]
  ? _TupleToNestedObject<F, U, R extends string ? Record<R, A> : never>
  : A;

type TupleToNestedObject<T, U> = _TupleToNestedObject<T, U, U>;
