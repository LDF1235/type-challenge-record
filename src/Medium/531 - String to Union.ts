...
type StringToUnion<T extends string> = _StringToUnion<T>;

type _StringToUnion<T extends string, A extends string[] = []> = T extends `${infer F}${infer R}`
  ? _StringToUnion<R, [...A, F]>
  : A[number];
