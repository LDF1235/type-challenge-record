...
type ShiftPop<T extends unknown[]> = T extends [infer F, ...infer R, infer L] ? R : [];

type GetMiddleElement<T extends unknown[]> = T['length'] extends 0 | 1 | 2 ? T : GetMiddleElement<ShiftPop<T>>;
