...
type _Unique<T extends unknown[], A extends unknown[] = []> = T extends [infer F, ...infer R]
  ? _Unique<R, Includes<A, F> extends true ? A : [...A, F]>
  : A;

type Unique<T extends unknown[]> = _Unique<T>;
