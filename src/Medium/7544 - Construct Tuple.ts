...
type _ConstructTuple<L extends number, A extends unknown[] = []> = A['length'] extends L
  ? A
  : _ConstructTuple<L, [...A, unknown]>;

type ConstructTuple<L extends number> = _ConstructTuple<L>;
