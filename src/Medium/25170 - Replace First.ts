...
> = T extends [infer F, ...infer Rest]
  ? _ReplaceFirst<
      ...
      S,
      R,
      [...Ret, IsReplace extends true ? F : F extends S ? R : F],
      IsReplace extends true ? true : F extends S ? true : false
    >
  : Ret;

type ReplaceFirst<T extends readonly unknown[], S, R> = _ReplaceFirst<T, S, R>;
